...
function CreateOrder() {
              ...
              <img
                src={
                  value.productDetailId.productId.thumbnail.startsWith("https")
                    ...
                    : "https://project-msnguyet-api.onrender.com/" +
                      value.productDetailId.productId.thumbnail
                }
              />
            ),
  ...
  const createOrderMomo = async () => {
    try {
      const res = await postAPI("/momo/create_order", { newTotal });
      createOrder("MOMO");
  ...
  const createOrderZalo = async () => {
    try {
      const res = await postAPI("/zalo/create_order", { newTotal });
      createOrder("ZALOPAY");
    ...
    <GooglePayButton
      ...
      paymentRequest={{
        ...
        transactionInfo: {
          ...
          totalPrice: `${(newTotal || 25000) / 250000}`,
          currencyCode: "USD",
          countryCode: "US",
        },
      }}
    ...
    <div>
      <div className="container-create-order">
        ...
        <Row style={{padding: "0 50px "}} >
          <Col span={24}> Lựa chọn phương thức thanh toán</Col>
          <Row >
            <Select
